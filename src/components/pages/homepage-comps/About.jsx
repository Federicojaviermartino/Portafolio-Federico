    ...
    return (
        ...
        className='relative w-full md:h-screen text-white h-unset'>
            ...
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg'>
                    ...
                    <p className="mb-4 py-6">Hey! I'm based in Spain and I'm Professional Full Stack Developer with more than 16 years of experience as a Accounting Analyst, head of logistic and salesperson. However, I felt that I had the potential for more, so my intellectual curiosity led me to enter into the world of programming.
                    </p>
