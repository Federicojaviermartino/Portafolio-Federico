        ...
        <section name="Home" className='relative w-full md:h-screen h-unset'>
            ...
            <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-0 md:flex-row md:gap-8'>
                ...
                <div className='flex flex-col justify-center items-center h-[85%] md:h-full order-2 md:order-1 md:items-start'>
                    ...
                    <h1 className='text-4xl md:text-6xl font-bold text-white mb-2 mt-3 md:mt-0 md:mb-4'>I'm Federico Javier Martino</h1>
                    ...
                    <p className='text-gray-300 py-4 max-x-md text-justify'>certified by Factoria F5, where I graduated as a Full Stack developer. Welcome to my portfolio, I'm excited to share my journey with you!</p>
