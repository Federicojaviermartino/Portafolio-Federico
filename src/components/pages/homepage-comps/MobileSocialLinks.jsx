    ...
    const links = [
        {
            ...
            href: 'https://www.linkedin.com/in/federicojaviermartino/',
            style: 'rounded-tr-md'
        },
        {
            id: 2,
            ...
            href: 'https://github.com/federicojaviermartino'
        },
        {
            id: 3,
            child: (
            ...
            href: 'mailto:federicojaviermartino@gmail.com'
        },
        {
            id: 4,
            child: (
            ...
            href: '/FullStack_Developer_FedericoJavierMartino.pdf',
            style: 'rounded-br-md',
            download: true
        }
    ]
